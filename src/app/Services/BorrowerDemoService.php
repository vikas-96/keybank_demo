...
use App\Models\BorrowerDemo;

class BorrowerDemoService
{
    public function __construct(BorrowerDemo $borrowerdemo )
    {
        $this->borrowerdemo = $borrowerdemo ;
    }

    public function index($request)
    {
        $data = $this->borrowerdemo;
    ...
    public function store($borrowerData)
    {
        try {
            ...
            $borrower = BorrowerDemo::create($borrowerData);
    ...
    {
        $borrowerdata = BorrowerDemo::find($id);
