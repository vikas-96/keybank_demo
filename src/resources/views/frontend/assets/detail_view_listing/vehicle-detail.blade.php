<div class="property-highlights row">
    ...
    <div class="col-md-6">
        ...
        {{ config('assets.vehicle_purpose.'.$value['vehicle']['vehicle_purpose']) }}
    </div>
    @endif --}}
 ...
 -->
        {{ config('assets.fuel_type.'.$value['vehicle']['fuel_type']) }}
    </div>
    @endif
 ...
 <!--        <strong>{{ ($value['vehicle']['asset_condition']) ?? null }}</strong> -->
        ...
        {{ config('assets.asset_condition.'.$value['vehicle']['asset_condition']) }}
    </div>
    @endif
    @if(in_array($template_id,config('list.vehicle.odo_meter_reading')))
    <div class="col-md-6">
        <span>ODO Meter Reading
                    (kms)</span>
        <strong>{{ ($value['vehicle']['odo_meter_reading']) ?? null }}</strong>
    </div>
    @endif
