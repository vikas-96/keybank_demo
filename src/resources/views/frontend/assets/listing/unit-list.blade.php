...
<div class="col-md-6">
    ...
    <strong>{{ config('assets.furnishing_status.'.$value['unit']['furnishing_status']) }}</strong>
</div>
@endif
{{--  @if(in_array($template_id,config('list.unit.flat_usp')) && isset($value['unit']['flat_usp']))
<div class="col-md-6">
    <span>Flat USP</span>
    <strong>{{ ($value['unit']['flat_usp'] ) ?? null }}</strong>
</div>
@endif
@if(in_array($template_id,config('list.unit.office_usp')) && isset($value['unit']['office_usp']))
<div class="col-md-6">
...
@if(in_array($template_id,config('list.unit.unit_usp')) && isset($value['unit']['unit_usp']))
<div class="col-md-6">
    <span>Unit USP</span>
