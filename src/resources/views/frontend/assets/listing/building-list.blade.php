@if(in_array($template_id,config('list.building.building_amenities')))
<div class="col-md-24">
    <span>Building Amenities</span>

    <strong>
        @php
        $building_amenities = assetdetail_value($value,'building','building_amenities',$template_id);
...
<div class="col-md-12">
    ...
    <strong>{{ config('assets.yes_no_options.'.$value['building']['lift_in_building']) }}</strong>
</div>
@endif
